 ...
 */
export async function getProcessingDataHtml(capIds) {
    ...
    try {
        return await new Promise((resolve, reject) => {
            const onResponse = async (response) => {
                try {
                    if (!response.url().includes("GetProcessingData"))
                        return;
            ...
            page
                .goto(`https://services.seattle.gov/Portal/Cap/CapDetail.aspx?Module=DPDPermits&TabName=DPDPermits&capID1=${encodeURIComponent(capIds.capID1)}&capID2=${encodeURIComponent(capIds.capID2)}&capID3=${encodeURIComponent(capIds.capID3)}&agencyCode=SEATTLE`)
                .catch(reject);
        });
    }
    finally {
...
if (entryFile && path.resolve(thisFile) === entryFile)
    void main();
//# sourceMappingURL=get-processing-data.js.map